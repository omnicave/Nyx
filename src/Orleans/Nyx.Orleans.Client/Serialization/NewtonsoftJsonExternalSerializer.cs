...
//
// [Obsolete("Use NewtonsoftJsonExternalSerializer instead")]
// public class NewtonsoftJsonSerializer : NewtonsoftJsonExternalSerializer
// {
//     public NewtonsoftJsonSerializer(IServiceProvider services) : base(services)
//     {
//     }
// }
//
// public class NewtonsoftJsonExternalSerializer : IExternalSerializer
// {
//     private const string UseFullAssemblyNamesProperty = "UseFullAssemblyNames";
//     private const string IndentJsonProperty = "IndentJSON";
//     private const string TypeNameHandlingProperty = "TypeNameHandling";
//     private readonly Lazy<JsonSerializerSettings> _settings;
//
//     public NewtonsoftJsonExternalSerializer(IServiceProvider services)
//     {
//         this._settings = new Lazy<JsonSerializerSettings>(() =>
//         {
//             var typeResolver = services.GetRequiredService<ITypeResolver>();
//             var grainFactory = services.GetRequiredService<IGrainFactory>();
//             return NewtonsoftJsonSerializerSettingsBuilder.GetDefaultsWithOrleansSupport(typeResolver, grainFactory);
//         });
//     }
//
//     /// <summary>
...
//     // public static JsonSerializerSettings GetDefaultSerializerSettings(ITypeResolver typeResolver,
...
//     public static JsonSerializerSettings UpdateSerializerSettings(
...
//     }
//
//     public static JsonSerializerSettings UpdateSerializerSettings(JsonSerializerSettings settings,
//         bool useFullAssemblyNames, bool indentJson, TypeNameHandling? typeNameHandling)
//     {
